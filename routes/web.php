...
//ajax
    ...
    Route::get('/ajax/auto_petugas', 'AjaxController@auto_petugas')->name('ajax_auto_petugas');
    Route::get('/ajax/auto_pelapor', 'AjaxController@auto_pelapor')->name('ajax_auto_pelapor');
